...
Route::post('/courses/{id}/enroll', [PublicController::class, 'enrollCourse'])->name('courses.enroll');
Route::post('/courses/{id}/add-to-cart', [PublicController::class, 'addToCart'])->name('courses.add-to-cart');
Route::get('/cart', [PublicController::class, 'cart'])->name('cart');
Route::post('/cart/remove/{courseId}', [PublicController::class, 'removeFromCart'])->name('cart.remove');
Route::post('/cart/checkout', [PublicController::class, 'checkout'])->name('cart.checkout');
